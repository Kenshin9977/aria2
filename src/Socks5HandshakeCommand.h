 ...
 */
/* copyright --> */
#ifndef D_SOCKS5_HANDSHAKE_COMMAND_H
#define D_SOCKS5_HANDSHAKE_COMMAND_H
...
// Performs SOCKS5 handshake (greeting + optional auth) then
...
public:
  ...
  ~Socks5HandshakeCommand() override;
...
#endif // D_SOCKS5_HANDSHAKE_COMMAND_H
