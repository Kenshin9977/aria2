...
public:
  ...
  public:
    ...
    {
      return std::make_unique<BtRequestMessage>(piece->getIndex(), 0, 0, blockIndex);
    }
  };
  ...
  void setUp()
  {
    pieceStorage_ = std::make_unique<MockPieceStorage>();
    ...
    requestFactory_ = std::make_unique<DefaultBtRequestFactory>();
