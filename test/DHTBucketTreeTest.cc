...
void DHTBucketTreeTest::testDig()
{
  ...
  {
    DHTBucketTreeNode b(std::make_unique<DHTBucketTreeNode>(bucket3),
                        std::make_unique<DHTBucketTreeNode>(bucket1));
...
void DHTBucketTreeTest::testFindBucketFor()
{
  ...
  }
  {
    ...
    //           |
    //    localNode is here
    auto b1 = std::make_unique<DHTBucketTreeNode>(bucket1);
    auto b2 = std::make_unique<DHTBucketTreeNode>(bucket2);
    auto b3 = std::make_unique<DHTBucketTreeNode>(bucket3);
    auto b4 = std::make_unique<DHTBucketTreeNode>(bucket4);
    auto b5 = std::make_unique<DHTBucketTreeNode>(bucket5);

    auto bp1 = std::make_unique<DHTBucketTreeNode>(std::move(b5), std::move(b3));
    auto bp2 = std::make_unique<DHTBucketTreeNode>(std::move(b4), std::move(bp1));
    auto bp3 = std::make_unique<DHTBucketTreeNode>(std::move(bp2), std::move(b1));
